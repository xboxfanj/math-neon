...
matmul4_neon(float m0[16], float m1[16], float d[16])
{
	...
	"vmla.32 		q14, q9, d4[1] 			\n\t"	//q14 = q9 * d4[1]
	"vmla.32 		q15, q9, d6[1] 			\n\t"	//q15 = q9 * d6[1]
	"vmla.32 		q12, q10, d1[0] 		\n\t"	//q12 = q10 * d0[0]
	"vmla.32 		q13, q10, d3[0] 		\n\t"	//q13 = q10 * d2[0]
	"vmla.32 		q14, q10, d5[0] 		\n\t"	//q14 = q10 * d4[0]
	"vmla.32 		q15, q10, d7[0] 		\n\t"	//q15 = q10 * d6[0]
	"vmla.32 		q12, q11, d1[1] 		\n\t"	//q12 = q11 * d0[1]
	"vmla.32 		q13, q11, d3[1] 		\n\t"	//q13 = q11 * d2[1]
	"vmla.32 		q14, q11, d5[1] 		\n\t"	//q14 = q11 * d4[1]
	"vmla.32 		q15, q11, d7[1]	 		\n\t"	//q15 = q11 * d6[1]
